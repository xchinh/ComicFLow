...
\begin{itemize}
    ...
    \item \textbf{Đặc điểm nhân khẩu học:} Việt Nam có tỷ lệ thâm nhập internet lên tới 78\%. Đáng chú ý, hơn 50\% dân số ở độ tuổi dưới 40. Tập khách hàng Gen Z đã được giáo dục về thói quen trả tiền cho nội dung số chất lượng qua các nền tảng như Spotify hay Netflix.
    \item \textbf{Hành vi và Phân khúc:} Khảo sát cho thấy 96.4\% người dùng mục tiêu có đọc truyện online, tập trung chủ yếu ở nhóm 19-22 tuổi (48.2\%) và 23-25 tuổi (23.2\%). Thể loại yêu thích nhất là Hành động/Phiêu lưu (69.6\%) và Tình cảm/Lãng mạn (53.6\%). Dù 62.5\% đang sử dụng web lậu, nhưng có tới 70.3\% sẵn sàng trả tiền cho nội dung bản quyền nếu mức giá hợp lý. Mức giá lý tưởng (sweet spot) là 1.000-5.000 đ/chương hoặc các gói Premium dao động từ 20.000-50.000 đ/tháng.
\end{itemize}
...
\begin{itemize}
    ...
    \item Giao diện sử dụng (UI) của các ứng dụng đọc truyện bị đánh giá khá thấp, chỉ đạt điểm trung bình 3.2/5.
    \item Quảng cáo xuất hiện quá nhiều, làm gián đoạn mạch đọc (đây là vấn đề lớn nhất, chiếm 90.7\% phản hồi).
...
\begin{itemize}
    ...
    \item Hoàn toàn thiếu hụt bảng điều khiển (dashboard) phân tích để nắm bắt số liệu độc giả.
...
\textbf{Key Resources (Nguồn lực chính):}
\begin{itemize}
...
\textbf{Key Activities (Hoạt động chính):}
\begin{itemize}
...
\textbf{Key Partners (Đối tác chính):}
\begin{itemize}
...
\textbf{Customer Relationships (Quan hệ khách hàng):}
\begin{itemize}
...
\textbf{Channels (Kênh tiếp cận \& phân phối):}
\begin{itemize}
